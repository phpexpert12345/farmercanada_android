...
public class CardConstant {
    ...
    public static final int OUR_ORDER_LIST_ADAPTER = 43;
    public static final int ONGOING_ORDER_LIST_ADAPTER = 44;
    public static final int PAST_ORDER_LIST_ADAPTER = 45;
