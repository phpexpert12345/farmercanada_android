 ...
 */
public class FarmReviewListApiModel {
    ...
    public FarmReviewData getData() {
        return data;
    }

    public void setData(FarmReviewData data) {
        this.data = data;
    }

    public class FarmReviewData {
