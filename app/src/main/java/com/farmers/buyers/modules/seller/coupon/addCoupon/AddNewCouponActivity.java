...
public class AddNewCouponActivity extends BaseActivity {
    ...
    private CheckBox add_new_coupon_checkbox;
    private boolean termCondCheck = false;
    ...
    private void init() {
        ...
        add_new_coupon_checkbox = findViewById(R.id.add_new_coupon_checkbox);
        ...
        add_new_coupon_checkbox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!termCondCheck) {
                    Toast.makeText(AddNewCouponActivity.this, "Please chekck terms and conditions!", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (extra == null) {
                    viewModel.addCoupon(
                            stateMachine,
                            couponCodeTv.getText().toString(),
                            percentTop,
                            discountPercentEt.getText().toString(),
                            minimumOrderAmountEt.getText().toString(),
                            termsConditionEt.getText().toString(),
                            startTimeTv.getText().toString(),
                            endTimeTv.getText().toString()
                    );
                } else {
                    viewModel.editCoupon(
                            updateStateMachine,
                            couponCodeTv.getText().toString(),
                            percentTop,
                            discountPercentEt.getText().toString(),
        ...
        stateMachine.observe(this, addCouponApiModelDataFetchState -> {
            switch (addCouponApiModelDataFetchState.status) {
                ...
                case ERROR:
                    error(addCouponApiModelDataFetchState.status_message);
                    break;
            }
        ...
        discountTypeRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    case R.id.add_new_coupon_percent_radio:
                        percentTop = "1";
                        break;
                    case R.id.add_new_coupon_fixed_radio:
                        percentTop = "0";
                        break;
        ...
        addCouponDiscountTimeType.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    case R.id.add_new_coupon_current_active_radio:
                        discountTypeRd = "0";
                        add_new_coupon_time_ll.setVisibility(View.GONE);
                        break;
                    case R.id.add_new_coupon_future_radio:
                        discountTypeRd = "1";
                        add_new_coupon_time_ll.setVisibility(View.VISIBLE);
                        break;
