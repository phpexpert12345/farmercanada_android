package com.farmers.buyers.modules.seller.sellerProfile.adapter;
...
import com.farmers.buyers.modules.seller.sellerProfile.view.SellerProfileHeaderDelegate;
import com.farmers.buyers.modules.seller.sellerProfile.view.SellerProfileHeaderViewHolder;
import com.farmers.buyers.storage.CardConstant;

/**
 * created by Mohammad Sajjad
 * on 09-02-2021 at 16:05
...
public class SellerProfileAdapter extends BaseAdapter {
    ...
    public SellerProfileAdapter(SellerProfileHeaderViewHolder.SellerProfileItemClickListener profileItemClickListener, SimpleRowViewHolder.OnSimpleRowItemClickedListener rowItemClickedListener,
    ...
    public void initDelegate() {
        delegates.put(CardConstant.PROFILE_HEADER_ADAPTER, new SellerProfileHeaderDelegate(profileItemClickListener));
