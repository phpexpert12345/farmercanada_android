...
import com.farmers.buyers.modules.profile.editProfile.EditProfileViewModel;
...
public class SellerEditProfileActivity extends BaseActivity {
...
//            }
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(SellerEditProfileActivity.this, new String[]{Manifest.permission.CAMERA,
                Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE
        }, 100);
    }

    public boolean checkCameraPermission() {
        return (ContextCompat.checkSelfPermission(SellerEditProfileActivity.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED
                && ContextCompat.checkSelfPermission(SellerEditProfileActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED &&
                ContextCompat.checkSelfPermission(SellerEditProfileActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED);
    }

    private void selectImage(int imageType) {
        try {
            PackageManager pm = SellerEditProfileActivity.this.getPackageManager();
            int hasPerm = pm.checkPermission(Manifest.permission.CAMERA, SellerEditProfileActivity.this.getPackageName());
