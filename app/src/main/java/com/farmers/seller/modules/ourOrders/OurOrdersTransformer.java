...
public class OurOrdersTransformer {
    ...
    public static List<SideMenuListItem> getReviewedList2() {
        ...
        item.add(new SideMenuListItem("My Coupon", R.mipmap.coupon_icon, 5));
        ...
        item.add(new SideMenuListItem("Logout", R.mipmap.profile_icon, 9));
        return item;
    }

    public static List<SideMenuListItem> getReviewedList() {
        List<SideMenuListItem> item = new ArrayList<>();
        item.add(new SideMenuListItem("My Store", R.mipmap.my_product_icon, 1));
        item.add(new SideMenuListItem("My Products", R.mipmap.my_product_icon, 2));
        item.add(new SideMenuListItem("My Coupon", R.mipmap.coupon_icon, 3));
        item.add(new SideMenuListItem("My Orders", R.mipmap.shopping_bag_icon, 4));
        item.add(new SideMenuListItem("My Earning", R.mipmap.earning_icon, 5));
        item.add(new SideMenuListItem("Broadcast Message", R.mipmap.broadcast_icon, 6));
        item.add(new SideMenuListItem("Manage Calender", R.mipmap.calender_icon, 7));
        item.add(new SideMenuListItem("Working Hours", R.mipmap.profile_icon, 8));
        item.add(new SideMenuListItem("My Profile", R.mipmap.profile_icon, 9));
        item.add(new SideMenuListItem("Logout", R.mipmap.profile_icon, 10));
        return item;
    }
}